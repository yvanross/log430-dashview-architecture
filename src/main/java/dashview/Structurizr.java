...
public class Structurizr {
  ...
  public void run() throws Exception {
    ...
    // componentDisplayController.setUrl("https://github.com/yvanross/log430-dashview-architecture/blob/master/src/main/java/dashview/Interfaces/IControllerDisplay.java");
    ...
    final Component componentCancanRouter = containerCancanEthernet.addComponent("cancanRouter", ICancanRouter.class,"Routeur du Server web wifi controlant le bus CanCan pour l'acquisition/diffusion des données des capteurs","CanCan bus Router");
    // componentCancanRouter.setUrl("https://github.com/yvanross/log430-dashview-architecture/blob/master/src/main/java/dashview/Interfaces/ICancanRouter.java");
    ...
    // componentControllerPilot.setUrl("https://github.com/yvanross/log430-dashview-architecture/blob/master/src/main/java/dashview/Interfaces/IControllerPilot.java");
     ...
     */
      containerCancanEthernet.uses(systemRacing, "Transmission des données de l'état des capteurs du véhicule").addTags("UDP");
